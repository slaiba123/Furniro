...
//           {/* Clerk Log Out Button */}
//           <SignedIn>
//             <SignOutButton signOutCallback={() => window.location.href = "/"}>
//               <button className="text-sm text-gray-700 hover:text-red-600 border border-gray-300 px-3 py-1 rounded-lg">
//                 Log Out
//               </button>
//             </SignOutButton>
//           </SignedIn>
  ...
  return (
    <header className="bg-white sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-10">
        ...
        {/* Icon Links + Auth Buttons (Desktop) */}
