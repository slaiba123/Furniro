...
//           <div className="relative bottom-[4rem] md:bottom-[6rem] left-2 md:left-5">
//             <div className="absolute bg-white bg-opacity-50 p-3 md:p-4 shadow-lg h-[4rem] md:h-[5rem] w-[8rem] md:w-[10rem]">
//               <h2 className="text-xs md:text-sm text-gray-500">
//                 {rooms[currentIndex].title}
//               </h2>
//               <h3 className="text-sm md:text-md font-bold text-gray-800">
//                 {rooms[currentIndex].name}
//               </h3>
//             </div>
//             <div className="absolute bg-brownMunday w-8 h-8 md:w-10 md:h-10 flex items-center justify-center left-[8rem] md:left-[10rem] top-8 md:top-10">
...
//           <div className="col-span-1 relative flex justify-center mt-6 md:mt-10 md:mr-[12rem]">
//             <div className="absolute flex space-x-2 bottom-5">
//               {rooms.map((room, index) => (
//                 <div
//                   key={room.id}
